...
base_parse = open("sample_baseline/result_without_word_feats_simple_avg.conllu", encoding='utf-8').readlines()
parse = open("max_norm_17/result_without_word_feats_simple_avg_raw_mod.conllu", encoding='utf-8').readlines()
